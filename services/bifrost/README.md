...
Download the binary from [the release page](https://github.com/leevlad/go/releases/tag/bifrost-v0.0.2) and use it with it's [Bifrost JS SDK](https://github.com/stellar/bifrost-js-sdk).
...
* `stellar`
  ...
  * `horizon` - URL to [horizon](https://github.com/leevlad/go/tree/master/services/horizon) server
